...
def main():
    ...
    if os.path.exists(os.path.join(opt.motion_text_alignment_pretrained_dir, 'pretrained_motion_text_alignment_512_movement_bigruco.pt')):
        pretrained_motion_text_alignment_weight_file = os.path.join(opt.motion_text_alignment_pretrained_dir, "pretrained_motion_text_alignment_512_movement_bigruco.pt")
        ...
        raise ValueError("pretrained_motion_text_alignment_contrast.pt must be exist.")
