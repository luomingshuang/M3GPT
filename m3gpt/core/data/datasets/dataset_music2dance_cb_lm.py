...
class Music2DanceDatasetCB(data.Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        self.different_music_dr = different_music_dr
    ...
    def __getitem__(self, item):
        ...
        if win_motion_size < m_tokens.shape[0]:
            ...
            if self.different_music_dr and p > 0.5:
                a_tokens_ds = []
                for idx in range(0, a_tokens.shape[0], 2):
                    a_token = a_tokens[idx:idx+1]
                    a_tokens_ds.append(a_token)
                a_tokens = np.concatenate(a_tokens_ds, axis=0)
