...
class Music2DanceDatasetCB_AD2A(data.Dataset):
    def __init__(
        self,
        ginfo,
        data_root,
    ...
    def __getitem__(self, item):
        ...
        idx = random.randint(win_audio_size, a_tokens.shape[0] - win_audio_size)
        dance_idx = int(idx / self.stride)
    
        a_tokens = a_tokens[(idx - win_audio_size) : (idx + win_audio_size)]
        m_tokens = a_tokens[dance_idx: dance_idx + win_motion_size]
